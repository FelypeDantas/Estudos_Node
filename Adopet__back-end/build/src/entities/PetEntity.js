...
var PetEntity = /** @class */ (function () {
    function PetEntity(nome, especie, dataDeNascimento, preco, adotado) {
        this.nome = nome;
    ...
    __decorate([
        (0, typeorm_1.Column)(),
        __metadata("design:type", Number)
    ], PetEntity.prototype, "preco", void 0);
    __decorate([
        (0, typeorm_1.Column)(),
    ...
    PetEntity = __decorate([
        (0, typeorm_1.Entity)(),
        __metadata("design:paramtypes", [String, String, Date, Number, Boolean])
    ], PetEntity);
    return PetEntity;
}());
